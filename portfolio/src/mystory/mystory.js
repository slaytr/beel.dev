    ...
    return (
      ...
      <div class="w3-half">
        <div class="w3-container w3-card w3-white w3-text-grey storyBox">
          <h1 class="w3-text-dark-grey" style={{paddingTop: 16}}>Hi, I’m Bill!</h1>
        ...
        <div class="w3-half">
          <div class="w3-container w3-card w3-white w3-text-grey storyBox" style={{paddingTop: 16}}>
            <h1 class="w3-text-dark-grey">My Story</h1>
            <p><i class="fas fa-kiwi-bird"></i> I grew up in the land of Kiwis. <i class="fas fa-kiwi-bird"></i><br />I always had a dream to be the best. It started with chess <i class="fas fa-chess-knight"></i> for me, when I was 10 the old
              ...
              bucks <i class="fas fa-dollar-sign"></i>. My addiction to began here. A year later, I was buying Yu-Gi-Oh cards from the weekend markets then flipping them at school on weekdays. I got into a lot of trouble for that later <i
            ...
            <p>As I grew up I continued playing chess, each year I would compete in the regional competitions, but it wasn’t enough for me. Soon, I was playing at national tournaments and finally international by the time I was 15 <i
                class="far fa-smile"></i>. Then, I switched from chess to League of Legends <i class="fas fa-gamepad"></i>. I was determined to play professionally as all kids dreamed to do, on a big stage and with a cheering audience. I trained
              everyday and worked very hard and realised that dream of mine. I played League professionally for a few years. </p>
            <p><i class="fas fa-graduation-cap"></i> After I graduated university <i class="fas fa-graduation-cap"></i><br /> I was lost like most of the grads. My career wasn’t financially sustainable to continue and I had grown up. So I started
            ...
            <hr />
            <h5 class="w3-text-dark-grey" style={{textAlign: "center"}}>Current Areas of Focus</h5>
