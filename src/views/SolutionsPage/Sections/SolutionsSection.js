        ...
        <div className={classes.section}>
            ...
            <GridContainer justify="center" style={{marginTop: "50px"}}>
                ...
                <GridItem cs={12} sm={6} md={6}>
                    ...
                    <h4 className={classes.description}>
                        A consensus platform is like a jury room, where a conclusion must be reached. Think of a
                        discussion
            ...
            <GridContainer justify="center" style={{marginTop: "50px"}}>
                <GridItem cs={12} sm={6} md={6}>
                    ...
                    <h3 className={classes.title}>Automatically calculate multiple WCAG colour combinations in
                        realtime</h3>
