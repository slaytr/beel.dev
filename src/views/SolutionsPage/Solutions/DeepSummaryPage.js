        ...
        <div>
          <div className={classes.container}>
            ...
            <div className={classes.description}>
              <p>
                Deep Summary reads a block of code and automatically it into plain english using AI <br/>
            ...
            <GridContainer justify="center">
                <GridItem xs={12} sm={12} md={12} style={{marginTop:"60px"}}>
                    ...
                    <Button color="disabled" disabled>Example 2</Button>
                    <Button color="disabled" disabled>Example 3</Button>
                    <Button color="disabled" disabled>Example 4</Button>
                </GridItem>
                ...
                <GridItem xs={12} sm={12} md={2} style={{display:"flex", alignItems:"center", justifyContent:"center"}}>
